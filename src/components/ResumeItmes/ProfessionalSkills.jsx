...
const ProfessionalSkills = () => {
  return (
   <div id='skills' className='flex flex-col'>
    <h1 className='text-5xl font-semibold m-auto'>My Skills</h1>
     <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1, transition: { duration: 0.5 } }}
      className="w-full flex sm:flex-row flex-col lgl:flex-row gap-[100px] lgl:gap-20"
    >
      ...
      <div className="w-full lgl:w-1/2">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">Taiwind Css</p>
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                initial={{ x: "-100%", opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
